...
const DEFAULT_MODEL_FAST = process.env.DEEPSEEK_MODEL_FAST ?? "deepseek-chat";
const DEFAULT_MODEL_REASONING = process.env.DEEPSEEK_MODEL_REASONING ?? "deepseek-reasoner";
const MAX_RETRIES = 2;
